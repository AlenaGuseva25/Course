...
def test_main():
    ...
    with patch("src.views.set_greeting") as mock_set_greeting, patch(
        "src.views.set_cards_dicts"
    ) as mock_set_cards, patch("src.views.set_five_trans_dicts") as mock_set_five_trans, patch(
        "src.views.set_currency_rates_dicts"
    ) as mock_set_currency_rates, patch(
        "src.views.stock_prices"
    ) as mock_stock_prices:
